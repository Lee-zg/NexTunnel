...
nextunnel server install --version v0.6.4-alpha --non-interactive --public-host example.com
...
nextunnel server up
nextunnel server update --version v0.6.4-alpha
...
| 参数 | 说明 |
| --- | --- |
| `--version` | Release 版本，例如 `v0.6.4-alpha` |
