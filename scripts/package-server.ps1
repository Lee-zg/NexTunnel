...
function New-ServerArchive {
  ...
  Copy-Item -LiteralPath (Join-Path $repositoryRoot "scripts\verify-public-endpoint.ps1") -Destination (Join-Path $packageScriptsDir "verify-public-endpoint.ps1") -Force
